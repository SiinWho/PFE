...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 21H21V19H3V21ZM3 17H21V15H3V17ZM3 13H21V11H3V13ZM3 9H21V7H3V9ZM3 5V3H21V5H3Z" fill="currentColor"/></svg>`,
      name: "Départements",
      path: "/departments",
    },
    {
      ...
      name: "Congés",
      subItems: [
        { name: "Mes Congés", path: "/leaves" },
        { name: "Gestion", path: "/leaves/management" },
        { name: "Soldes", path: "/leaves/balances", new: true },
        { name: "Calendrier", path: "/leaves/calendar" },
    ...
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 3L1 9L12 15L21 10.09V17H23V9M5 13.18V17.18L12 21L19 17.18V13.18L12 17L5 13.18Z" fill="currentColor"/></svg>`,
      name: "Compétences",
      subItems: [
        { name: "Catalogue", path: "/skills/catalog" },
        { name: "Matrice", path: "/skills/matrix" },
        { name: "Analyse Écarts", path: "/skills/gap-analysis" },
        { name: "Extraction CV", path: "/skills/cv-extraction" },
      ],
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14 2H6C4.89 2 4 2.89 4 4V20C4 21.11 4.89 22 6 22H18C19.11 22 20 21.11 20 20V8L14 2M13 9V3.5L18.5 9H13ZM10 12C10 10.9 10.9 10 12 10C13.1 10 14 10.9 14 12V14H16V16H8V14H10V12Z" fill="currentColor"/></svg>`,
      name: "Générateur CV",
      subItems: [
        { name: "Créateur Unifié", path: "/cv-generator" },
        { name: "Historique", path: "/cv-generator/history" },
      ],
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 15.5C13.93 15.5 15.5 13.93 15.5 12C15.5 10.07 13.93 8.5 12 8.5C10.07 8.5 8.5 10.07 8.5 12C8.5 13.93 10.07 15.5 12 15.5ZM19.43 12.98C19.47 12.66 19.5 12.34 19.5 12C19.5 11.66 19.47 11.34 19.42 11.02L21.54 9.37C21.73 9.22 21.78 8.95 21.66 8.73L19.66 5.27C19.54 5.05 19.27 4.97 19.05 5.05L16.56 6.05C16.03 5.65 15.48 5.32 14.87 5.07L14.49 2.42C14.46 2.18 14.25 2 14 2H10C9.75 2 9.54 2.18 9.51 2.42L9.13 5.07C8.52 5.32 7.96 5.66 7.44 6.05L4.95 5.05C4.73 4.97 4.46 5.05 4.34 5.27L2.34 8.73C2.21 8.95 2.27 9.22 2.46 9.37L4.58 11.02C4.53 11.34 4.5 11.67 4.5 12C4.5 12.33 4.53 12.66 4.58 12.98L2.46 14.63C2.27 14.78 2.22 15.05 2.34 15.27L4.34 18.73C4.46 18.95 4.73 19.03 4.95 18.95L7.44 17.95C7.96 18.35 8.52 18.68 9.13 18.93L9.51 21.58C9.54 21.82 9.75 22 10 22H14C14.25 22 14.46 21.82 14.49 21.58L14.87 18.93C15.48 18.68 16.03 18.34 16.56 17.95L19.05 18.95C19.27 19.03 19.54 18.95 19.66 18.73L21.66 15.27C21.78 15.05 21.73 14.78 21.54 14.63L19.43 12.98Z" fill="currentColor"/></svg>`,
      name: "Paramètres",
      subItems: [
        { name: "Utilisateurs", path: "/settings/users" },
        { name: "Rôles", path: "/settings/roles" },
