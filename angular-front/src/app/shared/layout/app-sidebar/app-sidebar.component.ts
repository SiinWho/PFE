...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      name: "Skills",
      subItems: [
        { name: "Catalog", path: "/skills/catalog" },
        { name: "Matrix", path: "/skills/matrix" },
        { name: "Gap Analysis", path: "/skills/gap-analysis" },
        { name: "CV Extraction", path: "/skills/cv-extraction" },
      ],
    },
    {
      ...
      name: "CV Generator",
      subItems: [
        { name: "Unified Builder", path: "/cv-generator" },
        { name: "Generation History", path: "/cv-generator/history" },
      ],
    },
    {
