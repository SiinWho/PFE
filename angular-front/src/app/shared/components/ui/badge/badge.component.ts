  ...
  get colorStyles() {
    const variants = {
      light: {
        ...
        info: 'bg-primary-light-50 text-primary-light-500 dark:bg-primary-light-500/15 dark:text-primary-light-500',
      ...
      solid: {
        ...
        info: 'bg-primary-light-500 text-white dark:text-white',
